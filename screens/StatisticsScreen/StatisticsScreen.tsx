...
export const StatisticsScreen: React.FC = () => {
  ...
  const fetchStats = async () => {
    try {
      ...
      const totalStudents = Object.values(users).filter(user => (user as any).role === 'student').length;
        ...
        <ScrollView style={styles.container}>
          ...
          <View style={styles.quickStatsContainer}>
            <View style={styles.quickStatCard}>
              ...
              <Text style={styles.quickStatValue}>{stats.totalStudents + stats.totalGuests}</Text>
            ...
            <View style={styles.quickStatCard}>
              ...
              <Text style={styles.quickStatValue}>{stats.lastWeekResponses}</Text>
          ...
          <View style={styles.detailedStatsCard}>
            ...
            <View style={styles.chartContainer}>
              ...
              {stats.responsesByDay.length > 0 ? (
                <LineChart
                  data={{
                    labels: stats.responsesByDay.slice(-7).map(d => d.date.split('-')[2]),
                    datasets: [{
                      data: stats.responsesByDay.slice(-7).map(d => d.count)
                    }]
                  }}
