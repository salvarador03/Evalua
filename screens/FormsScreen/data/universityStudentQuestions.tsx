...
export const universityStudentQuestions: Questions = {
    es: [
        {
            id: 1,
    ...
    en: [
        ...
        {
            id: 5,
            text: 'Compared to people my age, I make new friends and feel better with my peers thanks to the physical activity I do:',
            min: 'NOT AT ALL',
            max: 'VERY MUCH',
            range: Array.from({ length: 11 }, (_, i) => i)
        },
        {
            id: 6,
            text: 'Compared to people my age, my confidence in relation to physical activity is:',
            min: 'NONE',
            max: 'VERY HIGH',
            range: Array.from({ length: 11 }, (_, i) => i)
        },
    ...
    "pt-PT": [
        {
            id: 1,
            text: 'Em comparação com as pessoas da minha idade, a minha forma física global é:',
            min: 'MUITO MÁ/\nPÉSSIMA',
            max: 'MUITO BOA/\nEXCELENTE',
            range: Array.from({ length: 11 }, (_, i) => i)
        },
        {
            id: 2,
            text: 'Em comparação com as pessoas da minha idade, a quantidade de atividade física que faço semanalmente (por exemplo: praticar desporto, caminhar ou andar de bicicleta, etc.) é:',
            min: 'NADA/\nNENHUMA',
            max: 'MUITÍSSIMA',
            range: Array.from({ length: 11 }, (_, i) => i)
        },
        {
            id: 3,
            text: 'Em comparação com as pessoas da minha turma (apenas com aquelas que têm a minha idade), o meu conhecimento sobre os conteúdos de atividade física é:',
            min: 'NENHUM',
            max: 'MUITO BOM/\nEXCELENTE',
            range: Array.from({ length: 11 }, (_, i) => i)
        },
        {
            id: 4,
            text: 'Em comparação com as pessoas da minha idade, a minha motivação para realizar atividade física é:',
            min: 'NENHUMA',
            max: 'MUITÍSSIMA',
            range: Array.from({ length: 11 }, (_, i) => i)
        },
        {
            id: 5,
            text: 'Em comparação com as pessoas da minha idade, faço novos amigos e sinto-me melhor com os meus colegas graças à atividade física que realizo:',
            min: 'NADA/\nNENHUM',
            max: 'MUITÍSSIMO(A)',
            range: Array.from({ length: 11 }, (_, i) => i)
        },
    ...
    "pt-BR": [
        {
            id: 1,
            text: 'Em comparação com as pessoas da minha idade, minha forma física global é:',
            min: 'MUITO RUIM/\nPÉSSIMA',
            max: 'MUITO BOA/\nEXCELENTE',
            range: Array.from({ length: 11 }, (_, i) => i)
        },
        {
            id: 2,
            text: 'Em comparação com as pessoas da minha idade, a quantidade de atividade física que faço semanalmente (por exemplo: praticar esportes, caminhar ou andar de bicicleta, etc.) é:',
            min: 'NADA/\nNENHUMA',
            max: 'MUITÍSSIMA',
            range: Array.from({ length: 11 }, (_, i) => i)
        },
        ...
        {
            id: 4,
            text: 'Em comparação com as pessoas da minha idade, minha motivação para realizar atividade física é:',
            min: 'NENHUMA',
            max: 'MUITÍSSIMA',
            range: Array.from({ length: 11 }, (_, i) => i)
        },
        {
            id: 5,
            text: 'Em comparação com as pessoas da minha idade, faço novos amigos e me sinto melhor com meus colegas graças à atividade física que realizo:',
            min: 'NADA/\nNENHUM',
            max: 'MUITÍSSIMO(A)',
            range: Array.from({ length: 11 }, (_, i) => i)
        },
        ...
        {
            id: 8,
            text: 'As pessoas que têm uma boa alfabetização física têm uma série de características:\n\nA) Têm uma boa condição física.\n\nB) Têm mais conhecimentos sobre os conteúdos de atividade física.\n\nC) Estão mais motivadas para a realização de atividade física.\n\nD) São capazes de socializar (fazer amigos/as e melhorar suas relações) graças à atividade física.\n\nE) São mais seguras ao realizar atividade física.\n\nF) São mais habilidosas e competentes na realização de atividade física.\n\nEstas pessoas, após avaliarem as diferentes opções para realizar atividade física, escolhem participar frequentemente nelas ao longo da vida.\n\nTendo em conta as características de uma pessoa com uma boa alfabetização física, em comparação com as pessoas da minha idade, minha alfabetização física é:',
            min: 'MUITO RUIM/\nPÉSSIMA',
            max: 'MUITO BOA/\nEXCELENTE',
            range: Array.from({ length: 11 }, (_, i) => i)
        }
...
export const isUniversityStudent = (age: number): boolean => {
