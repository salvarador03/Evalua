    ...
    try {
      ...
      if (currentUser) {
        ...
        const userDataUpdate = {
          name: data?.name || currentUser.displayName || 'Profesor',
          email: currentUser.email || 'Sin email',
          displayName: currentUser.displayName || data?.name || 'Profesor',
        };
          ...
          <View style={styles.optionsContainer}>
            {isEditing === 'password' ? (
              ...
              <>
                ...
                >
                  <Ionicons name="key-outline" size={24} color="#9E7676" />
                  <Text style={styles.optionText}>Gestionar Códigos de Clase</Text>
                  <Ionicons name="chevron-forward" size={24} color="#9E7676" style={styles.optionArrow} />
                </TouchableOpacity>
